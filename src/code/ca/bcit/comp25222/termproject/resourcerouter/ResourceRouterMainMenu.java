package ca.bcit.comp25222.termproject.resourcerouter;
...
import ca.bcit.comp25222.termproject.resourcerouter.managers.HighScoreManager;
import ca.bcit.comp25222.termproject.resourcerouter.managers.ScoreEntry;
...
public class ResourceRouterMainMenu extends Application
{
    ...
    private static final double STATUS_LABEL_WIDTH = 500;
    ...
    private VBox createBottomArea() {
        ...
        promptLabel = new Label("Default Prompt Label");
        ...
        gameStartStopButton = createMenuButton("Start Sim");
    ...
    private void setupHighScoresOverlay()
    {
        ...
        highScoresOverlay.setPrefWidth(530);
        ...
        sL.setMaxWidth(SCORE_LIST_PREF_WIDTH);
        ...
        Platform.runLater(() -> {
            ...
            if (showStandard) {
                if (isSimRunning) {
                    ...
                    gameStartStopButton.setText("Stop Sim (E)");
                    ...
                    gameStartStopButton.setText("Start Sim (E)");
                    gameStartStopButton.setDisable(false);
    ...
    { // Handles pipe build / remove clicks
        gamePane.setOnMouseClicked((MouseEvent event) -> {
            ...
            if (clickedLogicalNode == null || gameController.isConnectorVisual(clickedVisual))
