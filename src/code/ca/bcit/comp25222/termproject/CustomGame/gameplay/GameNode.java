...
import ca.bcit.comp25222.termproject.CustomGame.util.Updatable;
 ...
 * </p>
 * <p>
 * By implementing the {@link ca.bcit.comp25222.termproject.CustomGame.util.Updatable} interface, each GameNode
                ...
                implements Updatable
{
    ...
    protected GameNode(final String id,
                       ...
                       final double y)
    {
        this.id = Objects.requireNonNull(id, "Node ID missing").trim();
        if (this.id.isEmpty())
        {
